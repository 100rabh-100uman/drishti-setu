    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-[#0d1527] border border-slate-800 rounded-xl p-4">
          <div className="text-xs font-semibold text-slate-400">PARAMETERS</div>
          <div className="text-2xl font-extrabold text-white mt-1 font-mono">{settingsList.length}</div>
        </div>
        ...
        <div className="bg-[#0d1527] border border-emerald-500/30 rounded-xl p-4">
          ...
          <div className="text-2xl font-extrabold text-white mt-1 font-mono">ENCRYPTED</div>
        </div>
        <div className="bg-[#0d1527] border border-violet-500/30 rounded-xl p-4">
          ...
          <div className="text-lg font-extrabold text-white mt-2 font-mono truncate">
                ...
                {filteredSettings.length === 0 ? (
                  ...
                  filteredSettings.map((item, idx) => (
                    <tr key={idx} className="hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="py-3.5 px-4 font-mono text-emerald-400 font-bold max-w-md truncate">
                        {item.value}
                      </td>
