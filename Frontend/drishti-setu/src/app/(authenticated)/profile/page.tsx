  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6 pb-24">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 mb-1">
            ...
            <span className="text-slate-700 font-bold">Officer Profile</span>
            <ChevronRight className="w-3 h-3 text-slate-400" />
            <span className="text-blue-600 font-mono">{employeeId}</span>
          </div>
        ...
        <div className="flex items-center gap-2.5">
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:bg-slate-50 shadow-sm transition-all cursor-pointer disabled:opacity-60"
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-red-600 bg-red-50 border border-red-200 hover:bg-red-100/80 transition-all cursor-pointer shadow-xs"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4 hover:border-slate-300 transition-colors">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900">Department & Posting</h3>
                <p className="text-[11px] text-slate-500">Official police assignment</p>
              </div>
            </div>
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <div className="font-bold text-slate-800 text-sm">{departmentName}</div>
            </div>
            ...
            <div>
              ...
              <div className="font-bold text-slate-800 capitalize">{designation}</div>
            </div>
            ...
            <div>
              ...
              <div className="font-semibold text-slate-800 bg-slate-50 p-2 rounded-lg border border-slate-100">
                {officeUnit}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                <span className="text-[10px] font-medium text-slate-400 block">District / Range</span>
                <span className="font-bold text-slate-800 text-xs">{district}</span>
              </div>
              <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                <span className="text-[10px] font-medium text-slate-400 block">State Division</span>
                <span className="font-bold text-slate-800 text-xs">Gujarat</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4 hover:border-slate-300 transition-colors">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">Government communication credentials</p>
              </div>
            </div>
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 border border-slate-100">
                <div className="flex items-center gap-2 truncate">
                  ...
                  <span className="font-semibold text-slate-800 truncate" title={officialEmail}>
                    {officialEmail}
                  </span>
                </div>
                <button
            ...
            <div className="grid grid-cols-2 gap-2 pt-1">
              <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                <span className="text-[10px] font-medium text-slate-400 block">Two-Factor OTP</span>
              ...
              <div className="p-2 bg-slate-50 rounded-lg border border-slate-100">
                <span className="text-[10px] font-medium text-slate-400 block">Account Status</span>
                <span className="inline-flex items-center gap-1 font-bold text-emerald-700 text-xs">
                  <CheckCircle2 className="w-3 h-3 text-emerald-600" />
                  Active
                </span>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4 hover:border-slate-300 transition-colors md:col-span-2 lg:col-span-1">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-500">Access authorization controls</p>
              </div>
            </div>
          ...
          <div className="space-y-3 text-xs">
            <div>
              ...
              <div className="font-semibold text-slate-800 bg-slate-50 p-2.5 rounded-lg border border-slate-100 flex items-center gap-2">
            ...
            <div>
              ...
              <div className="font-mono text-xs font-semibold text-slate-800 bg-slate-50 p-2.5 rounded-lg border border-slate-100 truncate">
                {requestId}
              </div>
            </div>

            <div className="p-3 rounded-xl bg-slate-900 text-white space-y-1.5 mt-2">
      ...
      <div className="bg-white rounded-2xl p-6 md:p-8 border border-slate-200 shadow-sm space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
          ...
          <span className="inline-flex items-center gap-1.5 text-xs font-bold px-3 py-1 rounded-full bg-slate-100 text-slate-700 border border-slate-200 self-start sm:self-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-slate-800 text-xs">CCTV Registry</span>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-slate-800 text-xs">GIS Surveillance</span>
              <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-emerald-100 text-emerald-800">
                Real-Time
              </span>
            </div>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-slate-800 text-xs">AI Analytic Feeds</span>
          ...
          <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/60 space-y-2">
            <div className="flex items-center justify-between">
              <span className="font-bold text-slate-800 text-xs">Audit & Reports</span>
              <span className={`text-[10px] font-bold px-2 py-0.5 rounded ${userRole === "Admin" ? "bg-emerald-100 text-emerald-800" : "bg-slate-200 text-slate-700"}`}>
