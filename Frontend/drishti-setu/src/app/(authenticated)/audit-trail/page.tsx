  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-violet-600 dark:text-violet-400 tracking-wider uppercase mb-1">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#0c162d] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs">
          <div className="text-xs font-semibold text-slate-500 dark:text-slate-400">TOTAL AUDIT EVENTS</div>
        ...
        <div className="bg-white dark:bg-[#0c162d] border border-violet-200 dark:border-violet-500/30 rounded-2xl p-4 shadow-xs">
          ...
          <div className="text-2xl font-extrabold text-slate-900 dark:text-white mt-1 font-mono">VERIFIED</div>
        </div>
        <div className="bg-white dark:bg-[#0c162d] border border-cyan-200 dark:border-cyan-500/30 rounded-2xl p-4 shadow-xs">
          ...
          <div className="text-2xl font-extrabold text-slate-900 dark:text-white mt-1 font-mono">100% ACTIONS</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-3 bg-white dark:bg-[#0c162d] border border-slate-200/80 dark:border-slate-800 p-3.5 rounded-2xl shadow-xs">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-800 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-violet-500"
          />
        </div>
      </div>
      ...
      {loading ? (
        <div className="bg-white dark:bg-[#0c162d] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-12 text-center text-slate-500 dark:text-slate-400 shadow-xs">
          <RefreshCw className="w-6 h-6 text-violet-600 dark:text-violet-400 animate-spin mx-auto mb-3" />
                  ...
                  filteredLogs.map((log, idx) => {
                    ...
                    return (
                      <tr key={log.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                          ...
                          <span
                            className={`px-2 py-0.5 text-[10px] font-bold rounded font-mono ${
                              isLogin
                                ...
                                : isAlert
                                ? "bg-rose-50 dark:bg-rose-950 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-700"
                        ...
                        <td className="py-3.5 px-4 text-slate-700 dark:text-slate-300 max-w-xs truncate" title={detailsStr}>
                          {detailsStr}
                        </td>
