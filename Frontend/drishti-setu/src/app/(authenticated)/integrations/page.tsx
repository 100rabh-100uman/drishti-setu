  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-700/60 pb-5">
        <div>
          <div className="flex items-center gap-2 text-xs font-bold text-teal-400 tracking-wider uppercase mb-1">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <div className="bg-[#0d1527] border border-slate-800 rounded-xl p-4">
          <div className="text-xs font-semibold text-slate-400">STATE GATEWAYS</div>
        ...
        <div className="bg-[#0d1527] border border-emerald-500/30 rounded-xl p-4">
          ...
          <div className="text-2xl font-extrabold text-white mt-1 font-mono">{connectedCount}</div>
        </div>
        <div className="bg-[#0d1527] border border-cyan-500/30 rounded-xl p-4">
          ...
          <div className="text-2xl font-extrabold text-white mt-1 font-mono">REST / WS / gRPC</div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-3 bg-[#0d1527] border border-slate-800 p-3.5 rounded-xl">
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            className="w-full bg-[#070d1d] border border-slate-800 rounded-lg pl-9 pr-3 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-teal-500"
          />
        </div>
      </div>
      ...
      {loading ? (
        <div className="bg-[#0d1527] border border-slate-800 rounded-xl p-12 text-center text-slate-400">
          <RefreshCw className="w-6 h-6 text-teal-400 animate-spin mx-auto mb-3" />
                  ...
                  filteredData.map((item, idx) => {
                    ...
                    return (
                      <tr key={item.id || idx} className="hover:bg-slate-800/30 transition-colors">
                        ...
                        <td className="py-3.5 px-4 font-mono text-cyan-400 text-[11px] max-w-xs truncate" title={item.endpoint}>
                          <div className="flex items-center gap-1">
                            <Link2 className="w-3 h-3 text-cyan-500 flex-shrink-0" />
