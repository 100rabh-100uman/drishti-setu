    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        <div className="bg-white dark:bg-[#0c162d] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-4 shadow-xs">
          <div className="text-xs font-semibold text-slate-500 dark:text-slate-400">LINKED AGENCIES</div>
        ...
        <div className="bg-white dark:bg-[#0c162d] border border-blue-200 dark:border-blue-500/30 rounded-2xl p-4 shadow-xs">
          ...
          <div className="text-2xl font-extrabold text-slate-900 dark:text-white mt-1 font-mono">POLICE & TRAFFIC</div>
        </div>
        <div className="bg-white dark:bg-[#0c162d] border border-emerald-200 dark:border-emerald-500/30 rounded-2xl p-4 shadow-xs">
          ...
          <div className="text-2xl font-extrabold text-slate-900 dark:text-white mt-1 font-mono">AMC / GMC / GSDMA</div>
        </div>
      </div>
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60">
                {filteredDepts.length === 0 ? (
                  ...
                  filteredDepts.map((dept, idx) => (
                    <tr key={dept.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                      ...
                      <td className="py-3.5 px-4 font-mono text-slate-700 dark:text-slate-300">
                        <span className="px-2 py-0.5 text-[10px] font-bold rounded bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
