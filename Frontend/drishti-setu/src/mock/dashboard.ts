...
export const mockDashboardData: DashboardData = {
  ...
  attentionItems: [
    ...
    },
    {
      ...
      type: 'onboarding',
      count: 8,
      title: 'Sentinel RTSP Streams',
      subtitle: 'Live Ingest catalogue (/api/ingest) active',
      priority: 'blue',
      link: '/resources',
    },
  ],
  quickActions: [
    ...
    { id: 'sentinel', label: 'Sentinel Ingest', icon: 'video', link: '/resources', color: 'text-cyan-600' },
