  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
        ...
        <div>
          <h3 className="text-base font-bold text-[#0a1b3f]">Authentication & Security</h3>
          <p className="text-xs text-slate-500">Configure handshake authorization credentials</p>
        </div>
      </div>

      {/* Security Disclaimer Notice */}
      <div className="flex items-start gap-3 p-3.5 bg-amber-50/70 border border-amber-200/80 rounded-xl text-xs text-amber-800">
      ...
      <div className="space-y-2">
        <label className="text-xs font-bold text-[#0a1b3f] uppercase tracking-wider block">
          ...
          {authMethods.map((m) => (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className={cn("text-xs font-bold", config.auth_method === m.id ? "text-blue-700" : "text-slate-800")}>
                  {m.label}
                </span>
                <span
                  className={cn(
                    "w-3.5 h-3.5 rounded-full border flex items-center justify-center",
                    config.auth_method === m.id ? "border-blue-600 bg-blue-600" : "border-slate-300"
                  )}
                >
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 text-xs font-mono bg-white border border-slate-200 rounded-xl outline-none focus:border-blue-500"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-2.5 pr-10 text-xs font-mono bg-white border ${
                    errors.api_key_value ? "border-red-300 focus:border-red-500" : "border-slate-200 focus:border-blue-500"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              <textarea
                ...
                className={`w-full p-3 font-mono text-xs bg-white border ${
                  errors.bearer_token ? "border-red-300 focus:border-red-500" : "border-slate-200 focus:border-blue-500"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-4 py-2.5 text-xs bg-white border ${
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-9 pr-10 py-2.5 text-xs bg-white border ${
